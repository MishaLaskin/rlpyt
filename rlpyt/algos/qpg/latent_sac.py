...
"""
Latent SAC is like normal SAC expect it wraps the original environment with a latent variable model
...
We will want to add the following additional fields to the buffer

1. latent_observation
